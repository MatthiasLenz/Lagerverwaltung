...
urlpatterns += format_suffix_patterns([url(r'^api/productall/', views.CompleteProductView.as_view(), name='productALL'),
    ...
    url(r'^api/04/lagerausgangmakepdf$', views_c01.lagerausgangmakepdf, name='lagerausgangmakepdf'),
    url(r'^api/05/lagerausgangmakepdf$', views_c01.lagerausgangmakepdf, name='lagerausgangmakepdf'),
