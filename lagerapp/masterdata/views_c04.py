# encoding=UTF-8
from models import Supplier04, PurchaseDoc04, PurchaseDocData04, DeliveryNote04, DeliveryNoteData04, Staff04, Project04
from serializers import SupplierSerializer04, PurchaseDocSerializer04, MinPurchaseDocSerializer, \
    PurchaseDocDataSerializer04, DeliveryNoteSerializer04, DeliveryNoteDataSerializer04, ProjectSerializer04
...
class ProjectViewSet(viewsets.ReadOnlyModelViewSet):
    queryset = Project04.objects.filter(projectsimulated=0)
    serializer_class = ProjectSerializer04
...
class SupplierViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    queryset = Supplier04.objects.all()
    serializer_class = SupplierSerializer04
...
class MinPurchaseDocViewSet(viewsets.GenericViewSet):
    ...
    queryset = PurchaseDoc04.objects.filter(module=5).filter(doctype=2).prefetch_related('data')
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(serializer.data, status=status.HTTP_204_CREATED, headers=headers)
...
class PurchaseDocViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = PurchaseDoc04.objects.filter(module=5).filter(doctype=2).prefetch_related('data')
    serializer_class = PurchaseDocSerializer04
...
class PurchaseDocDataViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = PurchaseDocData04.objects.all()
    serializer_class = PurchaseDocDataSerializer04
    pagination_class = LargeResultsSetPagination
...
class PurchaseDocSupplierViewSet(viewsets.ModelViewSet):
    authentication_classes = (TokenAuthentication,)
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = PurchaseDoc04.objects.filter(module=5).filter(doctype=2)
    supplierids = [pd.supplierid for pd in queryset]
    queryset = Supplier04.objects.filter(pk__in=supplierids)
    serializer_class = SupplierSerializer04
    pagination_class = None
...
class DeliveryNoteViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = DeliveryNote04.objects.filter(module=5).prefetch_related('data')
    serializer_class = DeliveryNoteSerializer04
    pagination_class = LargeResultsSetPagination
    filter_backends = (filters.DjangoFilterBackend,)
...
class DeliveryNoteDataViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    permission_classes = (IsAuthenticatedOrReadOnly,)
    queryset = DeliveryNoteData04.objects.all()
    serializer_class = DeliveryNoteDataSerializer04
    pagination_class = LargeResultsSetPagination
